...
export default defineConfig({
  ...
  head: [
    ...
    [
      ...
      {
        property: "og:title",
        content: "Espresso | HTTP Routing Framework for Go",
      },
    ],
    [
      "meta",
      {
        ...
        content:
          "Production-grade HTTP routing framework for Go, inspired by Axum and Tower",
      },
    ],
    ...
    [
      ...
      {
        property: "og:url",
        content: "https://suryakencana007.github.io/espresso/",
      },
    ],
    [
      "meta",
      {
        property: "og:image",
        content: "https://suryakencana007.github.io/espresso/logo.png",
      },
    ],
  ],
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: "API", link: "/api/", activeMatch: "/api/" },
      {
        ...
        items: [
          {
            text: "Changelog",
            link: "https://github.com/suryakencana007/espresso/releases",
          },
          {
            text: "Contributing",
            link: "https://github.com/suryakencana007/espresso/blob/main/CONTRIBUTING.md",
          },
        ],
      },
      {
    ...
    editLink: {
      pattern:
        "https://github.com/suryakencana007/espresso/edit/main/docs/:path",
